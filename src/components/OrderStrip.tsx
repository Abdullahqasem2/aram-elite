  ...
  return (
    <div className="bg-accent dark:bg-red-600 px-6 py-5 text-center">
      ...
      <div className="flex flex-wrap gap-3 justify-center mt-3.5">
        <a href="tel:+966502080228" className="bg-gold dark:bg-yellow-500 text-black dark:text-gray-900 px-7 py-3 rounded font-cond text-base font-bold uppercase hover:bg-yellow-400 dark:hover:bg-yellow-600 transition">📞 Call Now · اتصل الآن</a>
        <a href="https://wa.me/966502080228" className="border-2 border-gold dark:border-yellow-500 text-gold dark:text-yellow-400 px-7 py-2.5 rounded font-cond text-base font-bold uppercase hover:bg-gold hover:bg-opacity-10 dark:hover:bg-yellow-500 dark:hover:bg-opacity-10 transition">💬 WhatsApp</a>
